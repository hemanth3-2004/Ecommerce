    ...
    return(
        <div className="py-7">
            ...
            <div className="flex items-center justify-around  mr-20">
                    <div className="ml-20"><button className="border outline-none rounded-full bg-custom text-white flex px-1 py-2 hover:bg-red-700"><MenuIcon className="mr-1 ml-2"/><p className="text-sm">ALL CATEGORIES</p><KeyboardArrowDownIcon className="ml-1"/></button></div>

                     <div className="flex items-center justify-between gap-5 mr-10 ml-10">
                     <div className=""><button className="rounded-full flex gap-2 px-2 py-1 text-gray-500 pl-5 pr-5 text-sm font-bold hover:bg-gray-100"><img src="https://api.spicezgold.com/download/file_1734525204708_fash.png" width="25" height={10}  alt="fashion" /><p>FASHION</p></button></div>
