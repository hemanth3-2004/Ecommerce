    ...
    return (
        <header className="bg-white shadow-md px-4 md:px-16 ">
            <div className="flex justify-between items-center py-4">
                ...
                {/* Sign In and Menu */}
                <div className="flex items-center gap-4">
                    <button className="hidden md:flex items-center justify-center px-4 py-2 border outline-none bg-custom rounded-2xl text-white hover:bg-red-700">
                        Sign In
                    </button>
                    <button className="md:hidden flex items-center p-2 border rounded-full" onClick={handleClick}>
                        <MenuIcon />
                    </button>
                </div>
            </div>
