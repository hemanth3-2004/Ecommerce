...
function RelatedCard(props) {
  ...
  return (
      ...
      <div className="border border-2 border-solid border-gray-300 w-[15em] h-auto rounded-md bg-gray-100  hover:shadow-2xl hover:shadow-custom fixed relative" onClick={props.onClick}>
