...
function Cart() {
  return (
    <div className="bg-white text-gray-700 h-auto">
      ...
      <div className=' w-[25%] mr-[1%] h-fit rounded-md bg-white mt-[1%] shadow-md shadow-gray-400'>
       <h2 className="text-center font-medium text-[1.3rem] my-1">Products</h2>

       <div className=' w-[90%] ml-[4%] h-[80%] rounded-md shadow-md shadow-gray-400 mb-[4%]'>
       ...
       <div className=' my-[1%] mx-[.5%] flex flex-row '>
        ...
        <div className='flex flex-col items-center justify-around pb-2'>
        <h2 className='font-medium text-[1.2rem] text-center mt-1'>Rs: 356/-</h2>
        <button className='bg-custom text-[1.2rem] text-white rounded-full px-4 py-1 text-center'>Buy Now</button>
        </div>
       </div>
      </div>
      </div>
