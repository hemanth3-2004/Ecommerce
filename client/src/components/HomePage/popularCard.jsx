...
function PopularCard(props) {
  ...
  return (
      ...
      <div className="border border-2 border-solid border-gray-300 w-full h-[28rem] rounded-md bg-gray-100  hover:shadow-2xl hover:shadow-custom fixed relative" onClick={props.onClick} to="/detailedPage">
